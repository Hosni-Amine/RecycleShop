...
return(
    ...
    <div >
      <div className="container">
        ...
        <div className="parent-container col-md-12 col-xl-3 col-lg-3 col-sm-12 mb-4">
        ...
        <div className="parent-container col-md-12 col-col-xl-3 col-lg-3 col-sm-12 mb-4">
          <div className="card h-100">
            <div className="content text-center">
              <img src={`http://127.0.0.1:8000/teamwork.png`} className="img-fluid" alt="View Orders" style={{ height: 90 }} />
              <div className="title">Manage users</div>
              <h4 style={{ color: "green" }}>
                {ordersData.length > 0 ? `You have ${usersData.length} users` : 'No user available'}
                    </h4>
                </div>
                {ordersData.length > 0 && (
            <Link to='/Admin/users'>
            <button type="button" to='/Admin/users'>
              Manage users
            </button>
          </Link>
                )}      
        ...
        <div className="parent-container col-md-12 col-col-xl-3 col-lg-3 col-sm-12 mb-4">
          <div className="card h-100">
            ...
            <button type="button" to='/Admin/orders'>
              Manage orders
            </button>
          </Link>
                )}      
        ...
        <div className="parent-container col-md-12 col-xl-3 col-lg-3 col-sm-12 mb-4">
          <div className="card h-100">
            <div className="content text-center">
              <img src={`http://127.0.0.1:8000/package.png`} className="img-fluid" style={{ height:70 }} />
              <div className="title">Manage products</div>
              <h4 style={{ color: "green" }}>
              {productList.length > 0 ? `You have ${productList.length} products` : 'You have no saved product'}
                </h4>
                </div>
                {productList.length > 0 && (
            <Link to='/Admin/products'>
            <button type="button" to='/Admin/products'>
              Manage products
            </button>
          </Link>
            )}
